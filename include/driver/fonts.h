...
extern const unsigned char Font8x6[];
extern const unsigned char digit_16x24[];
extern const unsigned char GOST_16x32 [];
extern const unsigned char Times_16x24[];
extern const unsigned char courier_10x16[];
